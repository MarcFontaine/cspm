-----------------------------------------------------------------------------
-- |
-- Module      :  CSPM.Interpreter.PatternCompiler
...
compilePattern :: ModuleFromRenaming -> Module INT
compilePattern ast
  = castModule $ Data.Generics.Schemes.everywhere' (Data.Generics.Aliases.mkT compPat) ast
  where
